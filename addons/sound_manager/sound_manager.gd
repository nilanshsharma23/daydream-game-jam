...
func play_sound_with_random_pitch(resource: AudioStream, min_pitch: float = 0.8, max_pitch: float = 1.2, override_bus: String = "") -> AudioStreamPlayer:
	return play_sound_with_pitch(resource, randf_range(min_pitch, max_pitch), override_bus)
